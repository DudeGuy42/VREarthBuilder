...
public class GlobxelSpawner : MonoBehaviour
{
    ...
    void SpawnGlobxelConvert(Vector3 position)
    {
    ...
    void Update()
    {
        if(Input.GetMouseButton(0))
        {
            ...
            {
                SpawnGlobxelConvert(Camera.main.transform.position + 10f*Camera.main.transform.forward);
